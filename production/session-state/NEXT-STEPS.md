...
Done ✅: core-foundation (6), content-config (9), kaiju-parts 001–005, weapons (10), economy (5), **difficulty (4)**. EditMode suite: **273/273 GREEN** (Unity MCP). **Next code work: `stage` epic (7, mostly unblocked).** Blocked 🔒: bullet-sim impl (8) + kaiju encounters (3) on ADR-0001.
