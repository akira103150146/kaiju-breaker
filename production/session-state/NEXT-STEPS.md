...
Done ✅: core-foundation (6), content-config (9), kaiju-parts 001–005, weapons (10), economy (5), **difficulty (4)**, **stage 001+003**. EditMode suite: **296/296 GREEN** (Unity MCP). **Next code work: `stage` 002/004/005/006/007 (Integration — Unity prefab/spawn) or meta-save (pure logic-ish, unblocks ISaveService real impl).** Blocked 🔒: bullet-sim impl (8) + kaiju encounters (3) on ADR-0001.
